...
echo "updating to $IP_ADDR_VAULT"
...
sshpass -p ubnt ssh ubnt@$IP_ADDR_VAULT 'sshpass -p ubnt ssh ubnt@172.30.0.165 "sed -i \"s/null::respawn:\/bin\/ubnt_ispserver/null::respawn:\/tmp\/ubnt_ispserver/\" /etc/inittab"'
